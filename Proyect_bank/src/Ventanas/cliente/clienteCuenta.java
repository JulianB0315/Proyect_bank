...
public class clienteCuenta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        actulizar.setText("Actulizar datos");
        ...
        jPanel1Layout.setVerticalGroup(
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(jLabel10)
                                        .addComponent(saldoRecibir, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(38, 38, 38)
                                .addComponent(Transacion)
                                ...
                                .addComponent(Deposito)
                                .addGap(18, 18, 18)
                                .addComponent(actulizar, javax.swing.GroupLayout.PREFERRED_SIZE, 32,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        try {
            ...
            try {
                ...
                if ("debito".equals(tipoCuenta) && montoDeposito > saldoActual) {
                    JOptionPane.showMessageDialog(this, "El monto a retirar excede el saldo disponible.");
                    return;
                }
            } catch (NumberFormatException e) {
            ...
            ticket Boleta = new ticket(idTransaccion, idCuenta, idEmpleado, tipoTransaccion, descripcion, montoDeposito,
                    idCuentaRecibir);
