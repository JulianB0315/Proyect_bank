...
public class clienteRegistro extends javax.swing.JFrame {
        ...
        private void ButtonRegistro1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_ButtonRegistro1ActionPerformed
                ...
                // áéíóúÁÉÍÓÚ: Permite letras con acentos (tildes) tanto en minúsculas como en
                // mayúsculas
                // \\s: Permite espacios en blanco.
                // +: Indica que la cadena debe tener al menos un carácter válido (letra o
                // espacio).
                ...
                // \d es un carácter de escape que representa cualquier dígito del 0 al 9 y si
                // le agregamos otro \ se permite repetir digitos
                ...
                // Reconfigura el objeto Calendar para calcular la fecha límite para mayores de
                // edad (18 años atrás)
                ...
                //Ultima validacion de que todos los datos esten
                ...
                try (Connection conn = DBConnection.getConnection()) {
                        ...
                        ps.setString(1, idCliente); //String generado ppr el metodo generateIdCliente
                        ps.setString(2, dni);
                        ...
                        ps.executeUpdate();
                        //Manda un mensaje que todo se hizo correctamente
                        ...
                        //Manda un mensaje que no se puedo hacer le Insert into
        ...
        public void cerrar() {
                try {
                        //Altera el cierre de la interfaz para personalizala 
                        this.setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
                        addWindowListener(new WindowAdapter() {
                                public void windowClosing(WindowEvent e) {
                                        //Llama al metodo confirmar para personalizar la salida ami gusto
                                        Confirmar();
                                }
                        });
